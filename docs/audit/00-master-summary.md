...
> ⚠️ **USANG — arsip historis (basis Juni 2025, hanya console Admin).** Jangan pakai sebagai status terkini. Sumber kebenaran = **source code**; status ringkas & tunggal ada di [`docs/README.md`](../README.md). Disimpan sebagai jejak audit awal saja.
