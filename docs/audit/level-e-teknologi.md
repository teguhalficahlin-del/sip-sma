...
> ⚠️ **USANG — arsip historis (basis Juni 2025, hanya console Admin).** Jangan pakai sebagai status terkini. Sumber kebenaran = **source code**; status ringkas & tunggal ada di [`docs/README.md`](../README.md). *(Klaim "aplikasi guru belum dibangun / offline belum teruji" sudah TIDAK berlaku — portal guru + offline live.)*
